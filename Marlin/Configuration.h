...
#define STRING_CONFIG_H_AUTHOR "(olemin, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
#define MOTHERBOARD BOARD_RAMPS_14_EFF //BOARD_RAMPS_14_EFB
#endif
...
// // tmc2226
 #define Y_SERIAL_TX_PIN X_SERIAL_TX_PIN //40
 #define Y_SERIAL_RX_PIN X_SERIAL_RX_PIN //63<-resistor
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 52.15
  #define DEFAULT_bedKi 8.97
  #define DEFAULT_bedKd 202.22
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-26, -8, 0 }
